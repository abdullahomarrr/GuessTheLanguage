...
export default async function DashboardPage({ searchParams }: { searchParams: Promise<{ range?: string }> }) {
  ...
  return <div className="admin-shell">
    <aside><Link className="admin-brand" href="/"><span>L</span><div>PLAYLINGO<small>CONTROL</small></div></Link><nav><a href="#overview" className="active">Overview</a><a href="#audience">Audience</a><a href="#acquisition">Acquisition</a><a href="#visitors">Sessions</a><a href="#reviews">Audio reviews</a></nav><form action="/admin/api/logout" method="post"><button className="admin-logout">Sign out</button></form></aside>
